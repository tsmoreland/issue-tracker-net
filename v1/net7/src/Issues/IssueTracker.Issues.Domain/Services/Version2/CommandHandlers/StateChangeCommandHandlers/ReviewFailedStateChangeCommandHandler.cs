...
public sealed class ReviewFailedStateChangeCommandHandler : IRequestHandler<ReviewFailedStateChangeCommand>
{
    ...
    /// <inheritdoc />
    public async Task Handle(ReviewFailedStateChangeCommand request, CancellationToken cancellationToken)
    {
