...
{
    internal partial class TriageUserEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType? baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "IssueTracker.Issues.Domain.ModelAggregates.IssueAggregate.TriageUser",
                typeof(TriageUser),
                baseEntityType);
        ...
        public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var reporter = principalEntityType.AddNavigation("Reporter",
                runtimeForeignKey,
                onDependent: false,
                typeof(TriageUser),
                propertyInfo: typeof(Issue).GetProperty("Reporter", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Issue).GetField("_reporter", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                eagerLoaded: true);
