...
public sealed class CompletedStateChangeCommandHandler : IRequestHandler<CompletedStateChangeCommand>
{
    ...
    /// <inheritdoc />
    public async Task Handle(CompletedStateChangeCommand request, CancellationToken cancellationToken)
    {
