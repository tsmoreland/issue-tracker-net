...
public sealed class OpenStateChangeCommandHandler : IRequestHandler<OpenStateChangeCommand>
{
    ...
    /// <inheritdoc />
    public async Task Handle(OpenStateChangeCommand request, CancellationToken cancellationToken)
    {
