...
public sealed class TestFailedStateChangeCommandHandler : IRequestHandler<TestFailedStateChangeCommand>
{
    ...
    /// <inheritdoc />
    public async Task Handle(TestFailedStateChangeCommand request, CancellationToken cancellationToken)
    {
