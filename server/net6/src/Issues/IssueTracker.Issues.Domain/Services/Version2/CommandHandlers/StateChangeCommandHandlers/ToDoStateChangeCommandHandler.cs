...
public sealed class ToDoStateChangeCommandHandler : IRequestHandler<ToDoStateChangeCommand, Unit>
{
    ...
    /// <inheritdoc />
    public async Task<Unit> Handle(ToDoStateChangeCommand request, CancellationToken cancellationToken)
    {
